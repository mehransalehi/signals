...
import SignalsTableWithSuspenece from '../components/signalsTableWithSuspence';
...
export default function Signals() {
    ...
    return <>
        <div className="flex items-center  justify-between pt-2">
            <h1 className="text-xl font-bold">Signals List</h1>
            <Link href="signals/add">
                <NavigateButton Icon={FaRegPlusSquare} label={'Add Signal'} />
            </Link>
        </div>
        ...
        <div className='flex flex-col xl:flex-row gap-4 mt-4'>
            <div className="overflow-x-auto grow">
                <Suspense fallback={<p>Loading feed...</p>}>
                    <SignalsTableWithSuspenece></SignalsTableWithSuspenece>
                </Suspense>
            </div>
